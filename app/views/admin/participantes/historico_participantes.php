...
<?php $this->load->view( 'admin/navbar' ); ?>
	...
	<div class="container">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">Accesos de participantes</div>
			...
			<div class="col-md-12">
				...
				<div class="table-responsive">
					...
					<section>
						<table id="tabla_bitacora_participante" class="display table table-striped table-bordered table-responsive" cellspacing="0" width="100%">
							<thead>
								<tr>
									<th class="text-center cursora" width="30%">Usuario</th>
									<th class="text-center cursora" width="20%">Nick</th>
